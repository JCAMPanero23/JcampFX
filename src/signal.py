...
class Signal:
    ...
    session_tag: str = ""
    # Phase 3.7: Strategy object reference for exit config (SwingRider)
    ...
    # SwingRider metadata — populated by SwingRider.analyze(), None for other strategies
    swing_level: Optional[float] = None        # Pullback swing low/high for SL placement
